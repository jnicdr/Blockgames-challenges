...
const vendor = await ethers.getContract("Vendor", deployer);
  ...
  console.log("\n :rosette:  Sending all 1000 tokens to the vendor...\n");
  ...
  console.log("\n    :white_check_mark: confirming...\n");
  await sleep(5000); // wait 5 seconds for transaction to propagate

  // ToDo: change address to your frontend address vvvv
  console.log("\n :juggling:  Sending ownership to frontend address...\n")
  const ownershipTransaction = await vendor.transferOwnership("0xA91fb80b72Dd4f70d05EcDDC0F8b5200A9EB0035");
  console.log("\n    :white_check_mark: confirming...\n");
  ...
  // if (chainId !== "31337") {
  //   try {
  //     console.log(" :ticket: Verifing Contract on Etherscan... ");
  ...
  //     });
  //   } catch (e) {
  //     console.log(" :warning: Failed to verify contract on Etherscan ");
  //   }
  // }
};
